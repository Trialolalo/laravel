                ...
                <div class="table-register">
                    <div class="table-top">
                        <div class="table-edit">
                            ...
                            <div class="trash">
                                <button class="trash-slide destroy-button" data-endpoint="{{route('faqs_destroy', ["faq" =>  $faq_element->id])}}">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
@section('form')
    <div class="tabs">
        ...
        <div class="form-buttons">
            <div class="form-clean-button create-button"  data-endpoint="{{route('faqs_create')}}">
                <button>
            ...
            <div class="form-save-button store-button"  data-endpoint="{{route('faqs_store')}}">
                <button>
        ...
        <div class="tab-content active" data-tab="main">
            <div class="form-row">
                <div class="form-element">
                    ...
                    <div class="form-element-input">
                        <input class="validate" name="name" autocomplete="name" data-onlyletters="true" value="{{$faq->name ?? ''}}"/>
                    </div>
                </div>
            </div>
        </div>
